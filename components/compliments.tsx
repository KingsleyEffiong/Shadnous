    ...
    <section className="relative w-full h-auto py-28 text-white overflow-hidden">
      ...
      <div className="relative z-20 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          ...
          <Button className="rounded-full bg-gradient-to-r from-[#00C8FF] to-[#4FDFFF] text-black font-semibold px-8 py-4 hover:shadow-[0_0_25px_#00C8FF] transition-all duration-300">
            Get in Touch
          </Button>
        </motion.div>
      </div>
